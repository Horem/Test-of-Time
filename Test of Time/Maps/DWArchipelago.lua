...
--	PURPOSE: Produces widely varied tiny continents and islands.
------------------------------------------------------------------------------
...
function GeneratePlotTypes()
	...
	local sea_level_low = 58;
	local sea_level_normal = 64;
	...
	while done == false do
		...
		if iNumBiggestAreaTiles < iNumTotalLandTiles * 0.2 then
			done = true;
